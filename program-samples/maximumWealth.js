...
var maximumWealth = function (accounts) {
  ...
  if (accounts.length === 0 || (!(accounts[0].length) || accounts[0].length <= 0)) return 0;
...
console.log(maximumWealth([[0], [0], [3, 5]]));//8
console.log(maximumWealth([[1]]));//0
console.log(maximumWealth([[1,2,5]]));//8
